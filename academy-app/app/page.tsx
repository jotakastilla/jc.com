...
export default function Home() {
  ...
  return <main className="shell"><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(course) }} />
    ...
    <section className="hero academyHero"><div style={{ textAlign: "center" }}><small>LOCAL RESET ACADEMY</small><em>FORMACIÓN PRÁCTICA · DIRECTOS · RECURSOS · HERRAMIENTAS</em><h1 className="academyHeroTitle"><span>Crea, produce</span><span>y haz crecer</span><b>tu podcast</b></h1><p style={{ marginInline: "auto" }}>Academy nace dentro de un estudio profesional: aprende con procesos reales, recursos útiles y formación que evoluciona contigo.</p><div className="actions" style={{ justifyContent: "center" }}><Link className="btn" href="#biblioteca">Explorar Academy →</Link><Link className="textLink" href="#masterclass">Ver Masterclass presencial</Link></div></div><div className="signal"><header>REC ●　CAM 01　AUDIO　EDICIÓN</header><label>LOCAL RESET / CONTENIDO EN MOVIMIENTO</label><AudioImprovementDemo /><footer><b>ACADEMY · ABIERTO, FREE Y PREMIUM</b><span>Aprende desde donde estés</span></footer></div></section>
    <AcademyPlatform />
    <AccessGuide />
    <CourseIntro />
    <MasterclassDetails />
